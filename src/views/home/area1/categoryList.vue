<template>
    ...
    >
        <div class="upCategory">
            <span v-for="(quickTitle, index) in cate_1.quickEnter" :key="index" @click="goSearch({keyword: quickTitle})"
        ...
        <div
            ...
            :key="index"
        >
            <div class="c2" @click="goSearch({keyword: cate_2.c2name})">
                {{ cate_2.c2name }}<i class="iconfont icon-xiangyou1"></i>
            </div>
            <div class="c3">
                <span v-for="(cate_3, index) in cate_2.children" :key="index" @click="goSearch({keyword: cate_3.c3name})">{{
                    cate_3.c3name
                }}</span>
            </div>
        </div>
